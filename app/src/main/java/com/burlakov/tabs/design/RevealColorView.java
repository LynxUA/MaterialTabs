...
/**
 * Created by denysburlakov on 24.05.15.
 */
        ...
        import com.burlakov.tabs.design.util.BakedBezierInterpolator;
        import com.burlakov.tabs.design.util.UiHelper;
...
public class RevealColorView extends ViewGroup {
    ...
    public static final int RCV_ANIMATION_DURATION_HIDE_REVEAL = 420;
    ...
    public void reveal(final int x, final int y, final int color, Animator.AnimatorListener listener) {
        final int duration = RCV_ANIMATION_DURATION_HIDE_REVEAL;
